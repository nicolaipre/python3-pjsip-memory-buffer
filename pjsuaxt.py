...
class LogConfig:
    ...
    def __init__(self, level=-1, filename="", callback=None,
                 console_level=-1):
        self._cvt_from_pjsua(_pjsuaxt.logging_config_default())
        if level != -1:
            self.level = level
        if filename != "":
    ...
    def _cvt_to_pjsua(self):
        cfg = _pjsuaxt.logging_config_default()
...
class MediaConfig:
    ...
    def __init__(self):
        default = _pjsuaxt.media_config_default()
    ...
    def _cvt_to_pjsua(self):
        cfg = _pjsuaxt.media_config_default()
...
class TransportConfig:
    ...
    def _cvt_to_pjsua(self):
        cfg = _pjsuaxt.transport_config_default()
        cfg.port = self.port
...
class Transport:
    ...
    def info(self):
        ...
        ti = _pjsuaxt.transport_get_info(self._id)
        if not ti:
    ...
    def enable(self):
        ...
        lck = self._lib.auto_lock()
        err = _pjsuaxt.transport_set_enable(self._id, True)
        self._lib._err_check("enable()", self, err)

    def disable(self):
        """Disable this transport."""
        lck = self._lib.auto_lock()
        err = _pjsuaxt.transport_set_enable(self._id, 0)
    ...
    def close(self, force=False):
        ...
        """
        lck = self._lib.auto_lock()
        err = _pjsuaxt.transport_close(self._id, force)
...
class AccountConfig:
    ...
    def __init__(self, domain="", username="", password="", 
        ...
        """
        default = _pjsuaxt.acc_config_default()
        self._cvt_from_pjsua(default)
        if domain!="":
    ...
    def _cvt_to_pjsua(self):
        cfg = _pjsuaxt.acc_config_default()
...
class Account:
    ...
    def __init__(self, lib, id, cb=None):
        ...
        _pjsuaxt.acc_set_user_data(self._id, self)
        _Trace((self, 'created'))

    def __del__(self):
        if self._id != -1:
            _pjsuaxt.acc_set_user_data(self._id, 0)
        _Trace((self, 'destroyed'))
    ...
    def info(self):
        ...
        """
        lck = self._lib().auto_lock()
        ai = _pjsuaxt.acc_get_info(self._id)
        if ai==None:
    ...
    def is_valid(self):
        ...
        """
        lck = self._lib().auto_lock()
        return _pjsuaxt.acc_is_valid(self._id)
    ...
    def set_default(self):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.acc_set_default(self._id)
    ...
    def is_default(self):
        ...
        """
        lck = self._lib().auto_lock()
        def_id = _pjsuaxt.acc_get_default()
    ...
    def delete(self):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.acc_set_user_data(self._id, 0)
        self._lib()._err_check("delete()", self, err)
        err = _pjsuaxt.acc_del(self._id)
        self._lib()._err_check("delete()", self, err)
        self._id = -1
    ...
    def set_basic_status(self, is_online):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.acc_set_online_status(self._id, is_online)
    ...
    def set_presence_status(self, is_online, 
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.acc_set_online_status2(self._id, is_online, activity,
                                            pres_text, rpid_id)
    ...
    def set_registration(self, renew):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.acc_set_registration(self._id, renew)
    ...
    def set_transport(self, transport):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.acc_set_transport(self._id, transport._id)
    ...
    def make_call(self, dst_uri, cb=None, hdr_list=None):
        ...
        err, cid = _pjsuaxt.call_make_call(self._id, dst_uri, 0, 
    ...
    def add_buddy(self, uri, cb=None):
        ...
        """
        lck = self._lib().auto_lock()
        buddy_cfg = _pjsuaxt.buddy_config_default()
        buddy_cfg.uri = uri
        buddy_cfg.subscribe = False
        err, buddy_id = _pjsuaxt.buddy_add(buddy_cfg)
    ...
    def pres_notify(self, pres_obj, state, reason="", hdr_list=None):
        ...
        """
        lck = self._lib().auto_lock()
        _pjsuaxt.acc_pres_notify(self._id, pres_obj, state, reason, 
    ...
    def send_pager(self, uri, text, im_id=0, content_type="text/plain",
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.im_send(self._id, uri,
                             content_type, text,
                             Lib._create_msg_data(hdr_list),
                             im_id)
...
class Call:
    ...
    def __del__(self):
        if self._id != -1:
            _pjsuaxt.call_set_user_data(self._id, 0)
        _Trace((self, 'destroyed'))
    ...
    def attach_to_id(self, call_id):
        ...
        self._id = call_id
        if self._id != -1:
            _pjsuaxt.call_set_user_data(self._id, self)
    ...
    def info(self):
        ...
        """
        lck = self._lib().auto_lock()
        ci = _pjsuaxt.call_get_info(self._id)
        if not ci:
    ...
    def is_valid(self):
        ...
        """
        lck = self._lib().auto_lock()
        return _pjsuaxt.call_is_active(self._id)
    ...
    def dump_status(self, with_media=True, indent="", max_len=1024):
        ...
        """
        lck = self._lib().auto_lock()
        return _pjsuaxt.call_dump(self._id, with_media, max_len, indent)
    ...
    def answer(self, code=200, reason="", hdr_list=None):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.call_answer(self._id, code, reason, 
                                   Lib._create_msg_data(hdr_list))
    ...
    def hangup(self, code=603, reason="", hdr_list=None):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.call_hangup(self._id, code, reason, 
                                   Lib._create_msg_data(hdr_list))
    ...
    def hold(self, hdr_list=None):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.call_set_hold(self._id, Lib._create_msg_data(hdr_list))
    ...
    def unhold(self, hdr_list=None):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.call_reinvite(self._id, True, 
                                     Lib._create_msg_data(hdr_list))
    ...
    def update(self, hdr_list=None, options=0):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.call_update(self._id, options, 
                                   Lib._create_msg_data(hdr_list))
    ...
    def transfer(self, dest_uri, hdr_list=None):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.call_xfer(self._id, dest_uri, 
                                 Lib._create_msg_data(hdr_list))
    ...
    def transfer_to_call(self, call, hdr_list=None, options=0):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.call_xfer_replaces(self._id, call._id, options,
                                          Lib._create_msg_data(hdr_list))
    ...
    def dial_dtmf(self, digits):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.call_dial_dtmf(self._id, digits)
    ...
    def send_request(self, method, hdr_list=None, content_type=None,
        ...
        err = _pjsuaxt.call_send_request(self._id, method, msg_data)
    ...
    def send_pager(self, text, im_id=0, content_type="text/plain", 
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.call_send_im(self._id, \
                             content_type, text, \
                             Lib._create_msg_data(hdr_list), \
                             im_id)
        self._lib()._err_check("send_pager()", self, err)
...
class Buddy:
    ...
    def __init__(self, lib, id, account, cb):
        ...
        self.set_callback(cb)
        _pjsuaxt.buddy_set_user_data(self._id, self)
        _Trace((self, 'created'))

    def __del__(self):
        if self._id != -1:
            _pjsuaxt.buddy_set_user_data(self._id, 0)
        _Trace((self, 'destroyed'))
    ...
    def info(self):
        ...
        """
        lck = self._lib().auto_lock()
        return BuddyInfo(_pjsuaxt.buddy_get_info(self._id))
    ...
    def subscribe(self):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.buddy_subscribe_pres(self._id, True)
    ...
    def unsubscribe(self):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.buddy_subscribe_pres(self._id, False)
    ...
    def delete(self):
        ...
        if self._id != -1:
            _pjsuaxt.buddy_set_user_data(self._id, 0)
        err = _pjsuaxt.buddy_del(self._id)
        self._lib()._err_check("delete()", self, err)
    ...
    def send_pager(self, text, im_id=0, content_type="text/plain",
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.im_send(self._acc()._id, self.info().uri,
                             content_type, text,
                             Lib._create_msg_data(hdr_list),
                             im_id)
        self._lib()._err_check("send_pager()", self, err)
    ...
    def send_typing_ind(self, is_typing=True, hdr_list=None):
        ...
        """
        lck = self._lib().auto_lock()
        err = _pjsuaxt.im_typing(self._acc()._id, self.info().uri,
...
class Lib:
    ...
    def __init__(self):
        ...
        err = _pjsuaxt.create()
        self._err_check("_pjsuaxt.create()", None, err)
        _lib = self
    ...
    def init(self, ua_cfg=None, log_cfg=None, media_cfg=None):
        ...
        err = _pjsuaxt.init(py_ua_cfg, log_cfg._cvt_to_pjsua(), 
    ...
    def handle_events(self, timeout=50):
        ...
        """
        lck = self.auto_lock()
        return _pjsuaxt.handle_events(timeout)
    ...
    def thread_register(self, name):
        ...
        """
        dummy = 1
        err = _pjsuaxt.thread_register(name, dummy)
    ...
    def verify_sip_url(self, sip_url):
        ...
        """
        lck = self.auto_lock()
        return _pjsuaxt.verify_sip_url(sip_url)
    ...
    def create_transport(self, type, cfg=None):
        ...
        err, tp_id = _pjsuaxt.transport_create(type, cfg._cvt_to_pjsua())
    ...
    def create_account(self, acc_config, set_default=True, cb=None):
        ...
        """
        lck = self.auto_lock()
        err, acc_id = _pjsuaxt.acc_add(acc_config._cvt_to_pjsua(), set_default)
    ...
    def create_account_for_transport(self, transport, set_default=True,
        ...
        """
        lck = self.auto_lock()
        err, acc_id = _pjsuaxt.acc_add_local(transport._id, set_default)
    ...
    def modify_account(self, acc_id, acc_config):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.acc_modify(acc_id, acc_config._cvt_to_pjsua())
    ...
    def enum_snd_dev(self):
        ...
        """
        lck = self.auto_lock()
        sdi_list = _pjsuaxt.enum_snd_devs()
        info = []
        for sdi in sdi_list:
    ...
    def set_snd_dev(self, capture_dev, playback_dev):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.set_snd_dev(capture_dev, playback_dev)
    ...
    def conf_get_max_ports(self):
        ...
        """
        lck = self.auto_lock()
        return _pjsuaxt.conf_get_max_ports()
    ...
    def conf_connect(self, src_slot, dst_slot):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.conf_connect(src_slot, dst_slot)
    ...
    def conf_disconnect(self, src_slot, dst_slot):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.conf_disconnect(src_slot, dst_slot)
    ...
    def conf_set_tx_level(self, slot, level):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.conf_set_tx_level(slot, level)
    ...
    def conf_set_rx_level(self, slot, level):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.conf_set_rx_level(slot, level)
    ...
    def conf_get_signal_level(self, slot):
        ...
        """
        lck = self.auto_lock()
        err, tx_level, rx_level = _pjsuaxt.conf_get_signal_level(slot)
    ...
    def enum_codecs(self):
        ...
        """
        lck = self.auto_lock()
        ci_list = _pjsuaxt.enum_codecs()
        codec_info = []
        for ci in ci_list:
            cp = _pjsuaxt.codec_get_param(ci.codec_id)
            if cp:
    ...
    def set_codec_priority(self, name, priority):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.codec_set_priority(name, priority)
    ...
    def get_codec_parameter(self, name):
        ...
        """
        lck = self.auto_lock()
        cp = _pjsuaxt.codec_get_param(name)
        if not cp:
    ...
    def set_codec_parameter(self, name, param):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.codec_set_param(name, param._cvt_to_pjsua())
    ...
    def create_player(self, filename, loop=False):
        ...
        if not loop:
            opt = opt + 1
        err, player_id = _pjsuaxt.player_create(filename, opt)
    ...
    def player_get_slot(self, player_id):
        ...
        """
        lck = self.auto_lock()
        slot = _pjsuaxt.player_get_conf_port(player_id)
        if slot < 0:
    ...
    def player_set_pos(self, player_id, pos):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.player_set_pos(player_id, pos)
    ...
    def player_destroy(self, player_id):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.player_destroy(player_id)
    ...
    def create_playlist(self, filelist, label="playlist", loop=True):
        ...
        if not loop:
            opt = opt + 1
        err, playlist_id = _pjsuaxt.playlist_create(label, filelist, opt)
    ...
    def playlist_get_slot(self, playlist_id):
        ...
        """
        lck = self.auto_lock()
        slot = _pjsuaxt.player_get_conf_port(playlist_id)
        if slot < 0:
    ...
    def playlist_destroy(self, playlist_id):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.player_destroy(playlist_id)
    ...
    def create_recorder(self, filename):
        ...
        """
        lck = self.auto_lock()
        err, rec_id = _pjsuaxt.recorder_create(filename, 0, None, -1, 0)
    ...
    def recorder_get_slot(self, rec_id):
        ...
        """
        lck = self.auto_lock()
        slot = _pjsuaxt.recorder_get_conf_port(rec_id)
        if slot < 1:
    ...
    def recorder_destroy(self, rec_id):
        ...
        """
        lck = self.auto_lock()
        err = _pjsuaxt.recorder_destroy(rec_id)
    ...
    def _lookup_call(self, call_id):
        return _pjsuaxt.call_get_user_data(call_id)

    def _lookup_account(self, acc_id):
        return _pjsuaxt.acc_get_user_data(acc_id)

    def _lookup_buddy(self, buddy_id, uri=None):
        if buddy_id != -1:
            buddy = _pjsuaxt.buddy_get_user_data(buddy_id)
        elif uri:
            buddy_id = _pjsuaxt.buddy_find(uri)
            if buddy_id != -1:
                buddy = _pjsuaxt.buddy_get_user_data(buddy_id)
            else:
                buddy = None
    ...
    def _cb_on_incoming_call(self, acc_id, call_id, rdata):
        ...
        if acc:
            ...
            _pjsuaxt.call_hangup(call_id, 603, None, None)
    ...
    def _cb_on_call_state(self, call_id):
        ...
        if call:
            ...
            call._cb.on_state()
            if done:
                _pjsuaxt.call_set_user_data(call_id, 0)
        else:
            pass
...
def _worker_thread_main(arg):
    ...
    thread_desc = 0;
    err = _pjsuaxt.thread_register("python worker", thread_desc)
...
class MemPlayer:
    ...
    def create(self, loop=False):
        ...
        Keyword arguments
        loop    -- Boolean to specify whether playback should automatically restart upon EOF
        Return:
            error status
        """
    ...
    def get_write_available(self):
        """Returns how many samples can be put into mem player.
        """

        lck = self._lib().auto_lock()
        err, num_samples = _pjsuaxt.mem_player_write_available(self.port_id)
        self._lib()._err_check("mem_player_write_available", self, err)

        return num_samples

    def put_frame(self, frame):
        """ Puts a frame into the players buffer and returns the ID of the frame.

        The ID of the frame is the number of frames put in the buffer since
        the creation of the player.
        """
        lck = self._lib().auto_lock()
        err, id = _pjsuaxt.mem_player_put_frame(self.port_id, frame)
        self._lib()._err_check("mem_player_put_frame", self, err)

        return id

    def get_num_played_frames(self):
        """ Returns the number of played frames since creating of the player.
        """

        lck = self._lib().auto_lock()
        id = _pjsuaxt.mem_player_get_num_played_frames(self.port_id)

        return id

    def flush(self):
        """Empties the player's queue.
        """

        lck = self._lib().auto_lock()
        err = _pjsuaxt.mem_player_flush(self.port_id)
        self._lib()._err_check("mem_player_flush", self, err)
...
class MemCapture:
    ...
    def get_read_available(self):
        ...
        lck = self._lib().auto_lock()
        err, num_samples = _pjsuaxt.mem_capture_read_available(self.port_id)
    ...
    def get_frame(self):
        ...
        """
        lck = self._lib().auto_lock()
        err, frame = _pjsuaxt.mem_capture_get_frame(self.port_id)
        self._lib()._err_check("mem_capture_get_frame", self, err)
